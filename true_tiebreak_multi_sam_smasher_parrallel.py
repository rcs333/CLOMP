...
if __name__ == '__main__':
	...
	for file_base in [file_base]:
		...
		read_to_taxids_map = {}
		reads_seq_map = {}
		ze = open(file_base + 'tie_breaking_timing.txt', 'w')
		...
		for db_num in ['00','01','02','03','04','05','06','07','08','09','10','11','12','13']:
			...
			ze.write('Reading in file ' + file_name + ' took ' + file_runtime)
		per_base_runtime = str(timeit.default_timer() - base_start_time)
		ze.write(file_base + ' took ' + per_base_runtime + ' in total to read')
		...
		ze.write('Tie breaking ' + file_base + ' took ' + tie_break_time)
